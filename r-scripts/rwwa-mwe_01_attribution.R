...
ts_station <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Time Series CSV\\annual_max_pr_station_annual.csv", col.names = c("year", "pr"), sep = ";", header = TRUE)
ts_era5 <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Time Series CSV\\annual_max_pr_era5land_annual.csv", col.names = c("year", "pr"), sep = ";", header = TRUE)
ts_cerra <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Time Series CSV\\annual_max_pr_cerra_annual.csv", col.names = c("year", "pr"), sep = ";", header = TRUE)


#load historical model time series
model_climex_hist <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Model CSV\\CLIMEX_Hist\\annual_max_pr_CLIMEXI.csv", col.names = c("year", "pr", "GMST"), sep = ";", header = TRUE)

#load future model time series
model_climex_fut <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Model CSV\\CLIMEX_Fut\\annual_max_pr_CLIMEXI.csv", col.names = c("year", "pr", "GMST"), sep = ";", header = TRUE)
...
write.csv(res_era5, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/obs_reanalysis/res_ERA5-Land.csv")
write.csv(res_cerra, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/obs_reanalysis/res_CERRA.csv")
...
write.csv(res_stn, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/obs_reanalysis/res_Station.csv")
...
# Compile results
res <- t(sapply(
  list.files(path = "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/obs_reanalysis/", pattern = "\\.csv$", full.names = TRUE),
  read.csv,
  row.names = "X"
))
...
# Save to CSV
write.csv(res, file = "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/obs_reanalysis/res_obs.csv")
...
write.csv(res_climex, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/CLIMEX/res_CLIMEX.csv")
...
write.csv(res_climex_2deg, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/CLIMEX/res_CLIMEX_2deg.csv")
write.csv(res_climex_3deg, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/CLIMEX/res_CLIMEX_3deg.csv")
...
for(fnm in list.files(path = "O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Model CSV\\CORDEX\\FINAL_MODELS\\", pattern = "\\.csv$", full.names = T)) {
  print(fnm)
  ...
  save_path_2deg <- paste0("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\2deg\\Approved\\", model_name, ".csv")
  save_path_pars <- paste0("O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/pars/", model_name, ".csv")
  save_path_trends <- paste0("O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/trends/", model_name, ".csv")
...
# Compile results
res <- t(sapply(
  list.files(path = "O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\2deg\\RP_magnitude_realistic\\shape_disp_good\\", pattern = "\\.csv$", full.names = TRUE),
  read.csv,
  row.names = "X"
))
...
write.csv(res, file = "O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\approved_cordex_res\\res_cordex_2deg_addmodels_2050.csv")
...
# load the obs 
obs_res <- read.csv("O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/rwwa results/obs_reanalysis/res_obs.csv", row.names = "X")
model_res <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\approved_cordex_res\\res_cordex_2deg_addmodels_2050.csv", row.names = "X")
model_ensemble_res <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\ensembles\\res_CLIMEX_ensemble_add_models.csv", row.names = "X")

#load the cordex
model_res_3deg <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\approved_cordex_res\\res_cordex_3deg_addmodels_2050.csv", row.names = "X")

#load the ensembles (climex & cordex)
model_ensemble_2deg <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\ensembles\\res_CLIMEX_ensemble_2deg_add_models.csv", row.names = "X")
model_ensemble_3deg <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\rwwa results\\ensembles\\res_CLIMEX_ensemble_3deg_add_models.csv", row.names = "X")
