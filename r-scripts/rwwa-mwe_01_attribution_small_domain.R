...
ts_era5 <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\smaller_domain\\annual_max_era5land_smaller_domain.csv", col.names = c("year", "pr"), sep = ";", header = TRUE)
ts_cerra <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\smaller_domain\\annual_max_cerra_smaller_domain.csv", col.names = c("year", "pr"), sep = ";", header = TRUE)


#load historical model time series
model_climex_hist <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\smaller_domain\\CLIMEX\\annual_max_pr_CLIMEXI_hist_small_domain.csv", col.names = c("year", "pr", "GMST"), sep = ";", header = TRUE)

#load future model time series
model_climex_fut <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\smaller_domain\\CLIMEX\\annual_max_pr_CLIMEXI_fut_small_domain.csv", col.names = c("year", "pr", "GMST"), sep = ";", header = TRUE)


# combine into single dataframe
df_station <- merge(gmst, ts_station, by = "year", all = TRUE)
df_era5 <- merge(gmst[77:151, ], ts_era5, by = "year", all = TRUE)
df_cerra <- merge(gmst[111:148, ], ts_cerra, by = "year", all = TRUE)
...
write.csv(res_era5, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/obs_reanalysis/res_ERA5-Land.csv")
write.csv(res_cerra, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/obs_reanalysis/res_CERRA.csv")
...
write.csv(res_stn, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/obs_reanalysis/res_Station.csv")
...
# Compile results
res <- t(sapply(
  list.files(path = "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/obs_reanalysis/", pattern = "\\.csv$", full.names = TRUE),
  read.csv,
  row.names = "X"
))
...
# Save to CSV
write.csv(res, file = "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/obs_reanalysis/res_obs.csv")
...
write.csv(res_climex, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/CLIMEX/res_CLIMEX/res_CLIMEX.csv")
...
write.csv(res_climex_2deg, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/CLIMEX/res_CLIMEX/res_CLIMEX_2deg.csv")
write.csv(res_climex_3deg, "O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/CLIMEX/res_CLIMEX/res_CLIMEX_3deg.csv")
...
# Compile results
res <- t(sapply(
  list.files(path = "O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Model CSV\\CORDEX\\smaller_domain\\2deg\\", pattern = "\\.csv$", full.names = TRUE),
  read.csv,
  row.names = "X"
))
...
# Save to CSV
write.csv(res, file = "O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\Model CSV\\CORDEX\\smaller_domain\\2deg_aggregate\\res_cordex_2deg_smaller_domain.csv")
...
# load the obs 
obs_res <- read.csv("O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/smaller_domain/obs_reanalysis/res_obs.csv", row.names = "X")
model_res <- read.csv("O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/Model CSV/CORDEX/smaller_domain/2deg_aggregate/res_cordex_2deg_smaller_domain.csv", row.names = "X")
model_ensemble_res <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\smaller_domain\\CLIMEX\\res_CLIMEX\\res_CLIMEX_ensemble_add_models.csv", row.names = "X")

#load the cordex
model_res_3deg <- read.csv("O:/Man/Public/sharing-4270-CERM/MATNEW/CC_det_attr/Model CSV/CORDEX/smaller_domain/3deg_aggregate/res_cordex_3deg_smaller_domain.csv", row.names = "X")

#load the ensembles (climex & cordex)
model_ensemble_2deg <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\smaller_domain\\CLIMEX\\res_CLIMEX\\res_CLIMEX_ensemble_2deg_add_models.csv", row.names = "X")
model_ensemble_3deg <- read.csv("O:\\Man\\Public\\sharing-4270-CERM\\MATNEW\\CC_det_attr\\smaller_domain\\CLIMEX\\res_CLIMEX\\res_CLIMEX_ensemble_3deg_add_models.csv", row.names = "X")
