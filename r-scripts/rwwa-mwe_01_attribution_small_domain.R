...
ts_era5 <- read.csv("\\..\\annual_max_pr_era5land_smaller_domain.csv", col.names = c("year", "pr"), sep = ";", header = TRUE)
ts_cerra <- read.csv("\\..\\annual_max_pr_cerra_smaller_domain.csv", col.names = c("year", "pr"), sep = ";", header = TRUE)


#load historical model time series
model_climex_hist <- read.csv("\\..\\annual_max_pr_CLIMEXI_hist_small_domain.csv", col.names = c("year", "pr", "GMST"), sep = ";", header = TRUE)

#load future model time series
model_climex_fut <- read.csv("\\..\\annual_max_pr_CLIMEXI_fut_small_domain.csv", col.names = c("year", "pr", "GMST"), sep = ";", header = TRUE)
...
# Save to CSV
write.csv(res, file = "\\..\\res_cordex_2deg_smaller-domain.csv")
...
# load the obs 
obs_res <- read.csv("\\..\\res_obs_smaller-domain.csv", row.names = "X")
model_res <- read.csv("\\..\\res_cordex_2deg_smaller-domain.csv", row.names = "X")
model_ensemble_res <- read.csv("\\..\\res_CLIMEX_CORDEX_ensembles_smaller-domain.csv", row.names = "X")

#load the cordex
model_res_3deg <- read.csv("\\..\\res_cordex_3deg_smaller-domain.csv", row.names = "X")

#load the ensembles (climex & cordex)
model_ensemble_2deg <- read.csv("\\..\\res_CLIMEX_CORDEX_ensembles_2deg_smaller-domain.csv", row.names = "X")
model_ensemble_3deg <- read.csv("\\..\\res_CLIMEX_CORDEX_ensembles_3deg_smaller-domain.csv", row.names = "X")
